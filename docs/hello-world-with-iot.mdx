...
First, make sure you are all set up by following this [guideline](/getting-started.mdx).
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/guides/install-grandeur-library.webm" />
...
![State Diagram](/demos/js-app/internet-switch.webp)
...
Add your token, API key and deviceID into the Grandeur Credentials section of the code . Next add enter your WiFi Credentials and you are all good to go! [Here](/getting-started.mdx) is how you do it incase you have forgotten.
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/guides/canvas-button.webm" /><br />

You can also use the [Canvas guide](./guides/canvas.mdx) for reference.
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/guides/button-control.webm" />
