...
`{ code: "DATASTORE-DOCUMENTS-FETCHED", message: "Documents are fetched as a result of successful execution of the query" , nDocuments: documentsCount.length ? documentsCount[0].value : 0,
documents: documents,}`
