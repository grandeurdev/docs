...
Previously to interact with your devices, your options were limited to either [Grandeur Canvas](/references/canvas) or building an app using one of the [App SDKs](/references/app-sdk). But now, **sky is your limit**.
