...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/guides/register.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/guides/create-project.webm" />
