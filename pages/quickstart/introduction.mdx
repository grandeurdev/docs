...
- [Getting Started](./getting-started.mdx) - Start here if you are not sure what to do and set up your Grandeur account to provision your first device along with our [supported hardware](./guides/hardware/setting-boards/setting-up-esp32).
