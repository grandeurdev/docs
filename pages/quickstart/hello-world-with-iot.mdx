...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/canvas-button-widget-configure.webm" /><br />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/canvas-button-widget-demo.webm" />
