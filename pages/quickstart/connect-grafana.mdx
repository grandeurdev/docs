...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-signin.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-launch-instance.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-connect-data.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-install-json-plugin.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-install-mqtt-plugin.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-widget-get-device-variable.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-widget-on-device-variable.webm" />

### Final demo

Here's how your dashboard would work when you change the variable from Canvas:

<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/grafana-final-demo.webm" />
