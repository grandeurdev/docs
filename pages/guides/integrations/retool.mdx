...
In the **Headers** field, add the **Authorization** header and put your **Auth token** in it. To generate an **Auth token** for Retool, go to [Grandeur console's Access](https://console.grandeur.dev/access) tab.

Click **Save and Run** and you can see a complete response in the response section.


<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/retool/retool-basic-query.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/retool/retool-formatting-query.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/retool/retool-visualise.webm" />
