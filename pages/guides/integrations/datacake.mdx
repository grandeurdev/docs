...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/datacake/datacake-add-device.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/datacake/datacake-add-field.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/datacake/datacake-add-mqtt-server.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/datacake/datacake-add-uplink-decoder.webm" />
...
<ReactPlayer playing controls volume={0} width={832} height={468} url="/demos/datacake/datacake-final-demo.webm" />